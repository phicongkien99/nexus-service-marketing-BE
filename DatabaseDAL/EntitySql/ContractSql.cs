	...
	public class ContractSql : EntityBaseSql 
	{
        ...
        public override SqlCommand GetSqlCommandForInsert(BaseEntity baseEntity)
		{
            ...
            if (baseEntity != null)
            {
				...
				sqlCommand.Parameters.Add(new SqlParameter("@NextPayment", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.NextPayment));
