	...
	public class ConnectionStatusController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get()
		{
			try
			{
				...
				#endregion
				var lstData = MemoryInfo.GetAllConnectionStatus();
				if (lstData != null)
		...
		public async Task<IHttpActionResult> Get(int id)
		{
			try
			{
				...
				#endregion
				var data = MemoryInfo.GetConnectionStatus(id);
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Post([FromBody]ConnectionStatus req)
		{
			try
			{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]ConnectionStatus req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetConnectionStatus(id);
				if (obj == null)
				{
        ...
        #region Validation
        public static bool Validate(ConnectionStatus obj, out string errorCode, out string errorMess)
        {
            errorCode = null;
            errorMess = null;
            try
        ...
        public static bool ValidateUpdate(ConnectionStatus obj, out string errorCode, out string errorMess)
        {
            errorCode = null;
            errorMess = null;
            try
