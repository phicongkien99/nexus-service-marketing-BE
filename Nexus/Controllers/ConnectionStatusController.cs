...
namespace Nexus.Controllers
{
	public class ConnectionStatusController: ApiController
	{
		...
		#region Validation
		private bool Validate(ConnectionStatus obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(ConnectionStatus obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
