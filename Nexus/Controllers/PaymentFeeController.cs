	...
	public class PaymentFeeController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get()
		{
			try
			{
				...
				#endregion
				var lstData = MemoryInfo.GetAllPaymentFee();
		...
		#region Validation
		private bool Validate(PaymentFee obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(PaymentFee obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
