...
{
	public class ServicePackFeeController: ApiController
	{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Post([FromBody]ServicePackFee req)
		{
			try
			{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put([FromBody]ServicePackFee req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetServicePackFee(req.GetServicePackFeeKeys());
				if (obj == null)
				{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Delete([FromBody] ServicePackFee req)
		{
			try
			{
				string errorMessage = "UnknowError";
		...
		#region Validation
		private bool Validate(ServicePackFee obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(ServicePackFee obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
