...
namespace Nexus.Controllers
{
	public class ServicePackFeeController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get(int id)
		{
			try
			{
				var data = MemoryInfo.GetServicePackFee(id);
				var res = new RequestErrorCode(true, null, null);
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]ServicePackFee req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetServicePackFee(id);
				if (obj == null)
				{
