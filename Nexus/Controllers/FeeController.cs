...
namespace Nexus.Controllers
{
	public class FeeController: ApiController
	{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]Fee req)
		{
			try
			{
				string errorMessage = "UnknowError";
        ...
        #region Validation
        public static bool Validate(Fee obj, out string errorCode, out string errorMess)
        {
            errorCode = null;
            errorMess = null;
            try
        ...
        public static bool ValidateUpdate(Fee obj, out string errorCode, out string errorMess)
        {
            errorCode = null;
            errorMess = null;
            try
