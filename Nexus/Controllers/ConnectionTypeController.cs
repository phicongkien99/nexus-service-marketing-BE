...
namespace Nexus.Controllers
{
	public class ConnectionTypeController: ApiController
	{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Post([FromBody]ConnectionType req)
		{
			try
			{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]ConnectionType req)
		{
			try
			{
				string errorMessage = "UnknowError";
        ...
        #region Validation
        public static bool Validate(ConnectionType obj, out string errorCode, out string errorMess)
        {
            errorCode = null;
            errorMess = null;
            try
        ...
        public static bool ValidateUpdate(ConnectionType obj, out string errorCode, out string errorMess)
        {
            errorCode = null;
            errorMess = null;
            try
