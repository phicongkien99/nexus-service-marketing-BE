...
namespace Nexus.Controllers
{
	public class ConnectionTypeController: ApiController
	{
		...
		#region Validation
		private bool Validate(ConnectionType obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(ConnectionType obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
