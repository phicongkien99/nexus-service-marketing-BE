...
namespace Nexus.Controllers
{
	public class DeviceTypeController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get()
		{
			try
			{
				var lstData = MemoryInfo.GetAllDeviceType();
		...
		public async Task<IHttpActionResult> Get(int id)
		{
			try
			{
				var data = MemoryInfo.GetDeviceType(id);
				var res = new RequestErrorCode(true, null, null);
				res.DataResult = data;
				return Ok(res);
			}
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Post([FromBody]DeviceType req)
		{
			try
			{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]DeviceType req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetDeviceType(id);
				if (obj == null)
				{
		...
		#region Validation
		private bool Validate(DeviceType obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(DeviceType obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
