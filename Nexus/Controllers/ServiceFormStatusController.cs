...
{
	public class ServiceFormStatusController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get()
		{
			try
			{
				...
				#endregion
				var lstData = MemoryInfo.GetAllServiceFormStatus();
		...
		public async Task<IHttpActionResult> Get(int id)
		{
			try
			{
				...
				#endregion
				var data = MemoryInfo.GetServiceFormStatus(id);
				var res = new RequestErrorCode(true, null, null);
				res.DataResult = data;
				return Ok(res);
			}
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]ServiceFormStatus req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetServiceFormStatus(id);
				if (obj == null)
				{
