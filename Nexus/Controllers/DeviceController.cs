...
namespace Nexus.Controllers
{
	public class DeviceController: ApiController
	{
		...
		#region Validation
		private bool Validate(Device obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(Device obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
