	...
	public class DetailImportReceiptController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get(int id)
		{
			try
			{
				...
				#endregion
				var data = MemoryInfo.GetDetailImportReceipt(id);
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put(int id,[FromBody]DetailImportReceipt req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetDetailImportReceipt(id);
				if (obj == null)
				{
