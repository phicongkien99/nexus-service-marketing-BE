...
{
	public class DetailImportReceiptController: ApiController
	{
		...
		public async Task<IHttpActionResult> Get()
		{
			try
			{
				...
				#endregion
				var lstData = MemoryInfo.GetAllDetailImportReceipt();
				if (lstData != null)
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Put([FromBody]DetailImportReceipt req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetDetailImportReceipt(req.GetDetailImportReceiptKeys());
				if (obj == null)
				{
		...
		[EnableCors(origins: "*", headers: "*", methods: "*")]
		public async Task<IHttpActionResult> Delete([FromBody] DetailImportReceipt req)
		{
			try
			{
				string errorMessage = "UnknowError";
		...
		#region Validation
		private bool Validate(DetailImportReceipt obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
		...
		private bool ValidateUpdate(DetailImportReceipt obj, out string errorCode, out string errorMess)
		{
			errorCode = null;
			errorMess = null;
			try
